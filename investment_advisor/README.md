...
LangGraph-based Multi-Agent Investment Advisory System powered by **AWS Bedrock AgentCore Runtime** and **AgentCore Memory**.

## 🎯 Overview

An AI orchestrator that integrates 3 specialized agents through LangGraph workflows to provide comprehensive investment advisory services with automatic consultation history management.
...
sequenceDiagram
    ...
    participant I as Investment Advisor
...
# Navigate to investment_advisor folder
...
### Log Checking
```bash
aws logs tail /aws/bedrock-agentcore/investment-advisor --follow
```
...
```
investment_advisor/
├── investment_advisor.py    # LangGraph-based Multi-Agent workflow
...
This Investment Advisor is the final orchestration stage of the **AI Investment Advisor** system:
...
4. **Investment Advisor** (current) → Multi-agent orchestration and consultation history management

The complete system provides end-to-end investment advisory services through seamless agent collaboration.